"""
Validation tests for SaleService.

Tests sale service validation logic without requiring database connection.
"""
...
def test_service_instantiation():
    ...
    print(f"  → SaleService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_sale_service returns same instance."""
    from core.services.sale_service import get_sale_service
    
    service1 = get_sale_service()
    service2 = get_sale_service()
...
if __name__ == '__main__':
    print("=" * 70)
    print("SaleService Validation Tests")
    print("=" * 70)
    print()
