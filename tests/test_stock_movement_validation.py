"""
Validation tests for StockMovementService.

Tests stock_movement service validation logic without requiring database connection.
"""
...
def test_service_instantiation():
    ...
    print(f"  → StockMovementService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_stock_movement_service returns same instance."""
    from core.services.stock_movement_service import get_stock_movement_service
    
    service1 = get_stock_movement_service()
    service2 = get_stock_movement_service()
...
if __name__ == '__main__':
    print("=" * 70)
    print("StockMovementService Validation Tests")
    print("=" * 70)
    print()
