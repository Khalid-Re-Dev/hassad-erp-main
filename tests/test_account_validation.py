"""
Validation tests for AccountService.

Tests account service validation logic without requiring database connection.
"""
...
def test_service_instantiation():
    ...
    print(f"  → AccountService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_account_service returns same instance."""
    from core.services.account_service import get_account_service
...
if __name__ == '__main__':
    print("=" * 70)
    print("AccountService Validation Tests")
    print("=" * 70)
    print()
