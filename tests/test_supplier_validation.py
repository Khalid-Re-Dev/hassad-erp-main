"""
Validation tests for SupplierService.

Tests supplier service validation logic without requiring database connection.
"""
...
def test_service_instantiation():
    ...
    print(f"  → SupplierService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_supplier_service returns same instance."""
    from core.services.supplier_service import get_supplier_service
    
    service1 = get_supplier_service()
    service2 = get_supplier_service()
...
if __name__ == '__main__':
    print("=" * 70)
    print("SupplierService Validation Tests")
    print("=" * 70)
    print()
