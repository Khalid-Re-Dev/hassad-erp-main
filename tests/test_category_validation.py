"""
Validation tests for CategoryService.

Tests category service validation logic without requiring database connection.
"""
...
def test_service_instantiation():
    ...
    print(f"  → CategoryService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_category_service returns same instance."""
    from core.services.category_service import get_category_service
...
if __name__ == '__main__':
    print("=" * 70)
    print("CategoryService Validation Tests")
    print("=" * 70)
    print()
