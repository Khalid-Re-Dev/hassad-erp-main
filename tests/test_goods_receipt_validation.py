"""
Validation tests for GoodsReceiptService.

Tests goods_receipt service validation logic without requiring database connection.
"""
...
from core.services.goods_receipt_service import GoodsReceiptService
...
def test_service_instantiation():
    ...
    print(f"  → GoodsReceiptService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_goods_receipt_service returns same instance."""
    from core.services.goods_receipt_service import get_goods_receipt_service
    
    service1 = get_goods_receipt_service()
    service2 = get_goods_receipt_service()
...
if __name__ == '__main__':
    print("=" * 70)
    print("GoodsReceiptService Validation Tests")
    print("=" * 70)
    print()
