"""
Validation tests for PurchaseInvoiceService.

Tests purchase_invoice service validation logic without requiring database connection.
"""
...
from core.services.purchase_invoice_service import PurchaseInvoiceService
...
def test_service_instantiation():
    ...
    print(f"  → PurchaseInvoiceService instantiated successfully")
...
def test_singleton_pattern():
    """Test that get_purchase_invoice_service returns same instance."""
    from core.services.purchase_invoice_service import get_purchase_invoice_service
    
    service1 = get_purchase_invoice_service()
    service2 = get_purchase_invoice_service()
...
if __name__ == '__main__':
    print("=" * 70)
    print("PurchaseInvoiceService Validation Tests")
    print("=" * 70)
    print()
